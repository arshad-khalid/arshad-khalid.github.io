...
- **Personalized layouts** to showcase different sections (Blog, Projects, Resume, Media, etc.).
...
- All posts, pages, and content are written in **Markdown**, making it easy to manage and update.
- Supports embedded **code snippets**, **images**, and more.
